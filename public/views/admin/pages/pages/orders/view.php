...
if (!empty($lb_admin_is_ranked_5s)) {
    $lb_admin_ranked_5s_required_boosters = max(1, min(4, (int)($data['boosters'] ?? 1)));
...
<div class="lb-head card mb-4">
      ...
      <div class="page-header-actions d-flex align-items-center gap-2">
        ...
        <div class="dropdown nav-scroller-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="profileDropdown">
                            ...
                            <a class="dropdown-item js-admin-poke-client" href="#" data-ref-type="order" data-id="<?= (int)$data['id'] ?>">
                                <i class="fa-duotone fa-hand-point-up dropdown-item-icon"></i> Poke Client
                            </a>
                            ...
                            <?php switch ($data['status']) {
                                ...
                                case 'IN_PROGRESS': ?>
                                    ...
                                    <?php if (!empty($lb_admin_is_ranked_5s) && !empty($lb_admin_ranked_5s_open_slots)): ?>
                                      <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_booster_md">
                                          <i class="fa-duotone fa-user-plus dropdown-item-icon"></i> Add Booster
                                      </a>
                                    <?php endif; ?>
  ...
  <div class="lb-head__meta">
    ...
    <div class="lb-meta-pill lb-meta-pill--boosters">
      ...
      <div class="lb-meta-pill__v">
        <?php if (!empty($lb_admin_is_ranked_5s) && !empty($lb_admin_all_boosters_meta_html)): ?>
          <?= $lb_admin_all_boosters_meta_html ?>
    ...
    <div class="lb-meta-pill">
      ...
      <div class="lb-meta-pill__v">
        <?= $priceText ?>
        <?php if (!empty($lb_admin_is_ranked_5s) && !is_null($lb_ranked_5s_cut_per_booster)): ?>
...
<?php if ($showClaimedBanner): ?>
  <?php if (!empty($lb_admin_is_ranked_5s) && count($lb_admin_intro_boosters) > 1): ?>
    <div class="lb-r5s-booster-tabs mb-3" role="tablist" aria-label="Ranked 5s boosters">
                        ...
                        <?php foreach ($notes as $note): ?>
                            <div class="lb-note-item">
                                <a class="lb-note-edit" href="#" data-bs-toggle="modal" data-bs-target="#edit_note_md"
                                   data-note-id="<?= $note['id'] ?>" aria-label="Edit note">
...
<?php if (strtolower((string) ($data['game'] ?? '')) === 'lol'): ?>
<div class="card mb-4 lb-op-card">
        ...
        <div class="card-body">
          ...
          $format_rank = static function ($tier, $division, $lp): string {
          ...
          $start_tier_id = $tier_id_map[$start_tier_raw] ?? 0;
          $current_tier_id = $tier_id_map[$current_tier_raw] ?? 0;
          ...
          $op_is_pro_games_form = ($op_form_id === 26);
            ...
            <div class="lb-op-rank-row">
              <div class="lb-op-rank-box">
                <img class="lb-op-rank-img" id="riotProgressStartRankImg"
                  src="<?= ASSET_URL ?>/core/main/img/lol/ranks/max/<?= $start_tier_id ?>.png" alt="">
              ...
              <div class="lb-op-rank-box lb-op-rank-box--current">
                <img class="lb-op-rank-img" id="riotProgressCurrentRankImg"
                  src="<?= ASSET_URL ?>/core/main/img/lol/ranks/max/<?= $current_tier_id ?>.png" alt="">
...
<div class="card mb-4 lb-overview-card">
            ...
            <div class="card-body">
                <ul class="lb-ov-grid">
                    ...
                    <?php if (in_array($data['game'], ['lol', 'tft'], true)): ?>
                        <li class="lb-ov-item">
                        ...
                        <?php if (!empty($data['queue_type'])): ?>
                            <li class="lb-ov-item">
                                <div class="lb-ov-ico">🚧</div>
                                <div class="lb-ov-label">Queue Type</div>
                                <div class="lb-ov-value"><?= util_format_default_type($data['queue_type']) ?></div>
                            </li>
                        <?php endif; ?>



                        <?php if (!empty($data['start_lp'])): ?>
                            <li class="lb-ov-item">
                                <div class="lb-ov-ico">🏁</div>
                                <div class="lb-ov-label">Start LP</div>
                                <div class="lb-ov-value"><?= util_format_start_lp_range($data['start_lp']) ?></div>
                            </li>
                        <?php endif; ?>

                        <?php if ($data['end_tier'] == 8 && !empty($data['end_lp'])): ?>
                            <li class="lb-ov-item">
                                <div class="lb-ov-ico">🚩</div>
...
<div class="card mb-4">
            ...
            <div class="card-body">
                <?php
                $options = ['roles', 'champions', 'agents', 'flash_position', 'vpn_country', 'is_priority', 'is_streaming', 'is_solo_only', 'is_bonus_win', 'is_offline_mode', 'is_coaching', 'is_hidden_duo', 'is_undercover_winrate', 'is_moderate_kda'];
                $hasOption = false;
                ?>
        ...
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <?php
              ...
              $accNoun = $isRiotOnly ? 'Riot ID' : $loginGameLabel . ' Logins';
              $hasRiot = !empty(trim((string)($data['ign'] ?? '')));
          ...
          <div class="card-body">
            ...
            <div class="lb-acc-details">
              ...
              <?php if (!$isRiotOnly): ?>
              <div class="lb-acc-row">
                <div class="lb-acc-label"><?= $loginGameLabel ?> Username</div>
                <div class="lb-acc-actions">
                  <div class="lb-acc-value <?= $loginVal !== '' ? '' : 'is-missing' ?> js-copyable" data-copy="<?= $loginCopy ?>" title="Click to copy">
                    <?= $loginVal !== '' ? $loginCopy : '—' ?>
                  </div>
                  <button type="button" class="lb-acc-copy js-copy-login" data-copy="<?= $loginCopy ?>" aria-label="Copy <?= $loginGameLabel ?> Username" <?= $loginVal !== '' ? '' : 'disabled' ?>>
                    <i class="fa-duotone fa-copy"></i>
                  </button>
                </div>
              </div>
              ...
              <div class="lb-acc-row">
                <div class="lb-acc-label"><?= $loginGameLabel ?> Password</div>
                <div class="lb-acc-actions">
                  <div class="lb-acc-value <?= $passVal !== '' ? '' : 'is-missing' ?> js-copyable" data-copy="<?= $passCopy ?>" title="Click to copy">
                    <?= $passVal !== '' ? $passCopy : '—' ?>
                  </div>
                  <button type="button" class="lb-acc-copy js-copy-login" data-copy="<?= $passCopy ?>" aria-label="Copy <?= $loginGameLabel ?> Password" <?= $passVal !== '' ? '' : 'disabled' ?>>
                    <i class="fa-duotone fa-copy"></i>
                  </button>
                </div>
              </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="tom-select-custom tom-select-custom-with-tags lb-r5s-booster-select-wrap">
                        ...
                        "placeholder": "Search booster..."}'>
                            <option value=""></option>
                            <?php foreach (db_get_rows('boosters', ['select' => 'username,id', 'is_banned' => 0]) as $booster): ?>
    ...
    <div class="modal-content">
      <form class="ajax-form" action="<?= AJAX_URL ?>">
        ...
        <div class="modal-body">
          ...
          <?php if (!empty($lb_admin_is_ranked_5s) && !empty($lb_admin_ranked_5s_boosters)): ?>
            <div class="rb-section">
              ...
              <div class="lb-r5s-remove-select">
                <?php foreach ($lb_admin_ranked_5s_boosters as $idx => $r5remove): ?>
                  <?php
                    ...
                    $r5removeLane = str_replace(['TopLane','MidLane','AdCarry'], ['Top','Mid','ADC'], (string)($r5remove['role'] ?? ''));
              ...
              <div class="form-text mt-2">Only the selected booster will be removed from this Ranked 5s order. Other booster lanes stay assigned.</div>
            </div>
                        ...
                        <div class="accordion accordion-icon-toggle" id="panel-1">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3 fv-row order-type">
                                        ...
                                        <select class="form-select" name="orders-form_id"
                                            ...
                                            <?= util_load_boost_forms_select($data['form_id'], $data['game'] === 'tft' ? 'tft' : 'lol') ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row border-bottom mb-4">
                                    ...
                                    <div class="col-lg-3 mb-3 fv-row order-cut">
                                        <?php $canEditBoosterCut = in_array(strtolower(ADMIN_DATA['email']), $allowedEmails); ?>
                                        <?php if (!empty($lb_admin_is_ranked_5s)): ?>
                                    ...
                                    <div class="col-lg-2 col-md-6 mb-3 fv-row order-duo">
                                        ...
                                        <input type="hidden" name="order_options-is_duo" value="<?= !empty($lb_admin_is_ranked_5s) ? '1' : '0' ?>">
                                        <div class="form-check form-switch form-check-custom form-check-solid mt-2">
                                            <input class="form-check-input" name="order_options-is_duo" type="checkbox"
                                                value="1" <?= ($data['is_duo'] || !empty($lb_admin_is_ranked_5s)) ? 'checked' : null ?>>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Body-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3 fv-row order-flash-position">
                                ...
                                <div class="row border-bottom mb-4">
                                    ...
                                    <div class="col-md-4 mb-3 fv-row order-offline-mode">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3 fv-row order-login">
                                    <label class="fs-6 fw-bold form-label mb-2"><?= htmlspecialchars($data['game'] === 'tft' ? 'TFT Username' : 'LoL Username') ?></label>
                                    <input type="text" class="form-control" name="order_accounts-login"
                                        value="<?= $data['login'] ?? null ?>" placeholder="<?= htmlspecialchars($data['game'] === 'tft' ? 'TFT Username' : 'LoL Username') ?>">
                                </div>
                                <div class="col-lg-6 mb-3 fv-row order-password">
                                    <label class="fs-6 fw-bold form-label mb-2"><?= htmlspecialchars($data['game'] === 'tft' ? 'TFT Password' : 'LoL Password') ?></label>
...
window.lbOrderViewStatusUpdate = function (data) {
  if (!data || parseInt(data.order_id || 0, 10) === parseInt(order_id, 10)) {
    if (lbIsRanked5sOrder && data && (data.type === 'ranked_5s_lanes_update' || data.type === 'ranked_5s_booster_removed' || data.force_check === true)) {
      setTimeout(function () { location.reload(); }, 450);
      return;
    }
    checkOrderStatusSoft();
  }
};
...
$(document).ready(function() {
        ...
        // Chat fallback: fast only when WebSocket is missing.
        // With WebSocket connected, chat updates arrive instantly through chat_update.
        ...
        // Status fallback, slower than before. Realtime event triggers immediately when available.
        setInterval(function () {
          if (document.visibilityState !== 'visible') return;
          if (window.lbRealtimeConnected) return;
          checkOrderStatusSoft();
...
<script>
    function handleLoLFields(form_id) {
        ...
        const lolFormIds = ['1','2','3','4','9','17','18','19','20','26'];
        ...
        function syncAccountFieldLabels(form_id) {
            ...
            let loginLabel = 'LoL Username';
            let passwordLabel = 'LoL Password';
...
<script>
  $(document).ready(function () {
    ...
    $(document).on('click', '.js-admin-poke-client', function (e) {
      ...
      $btn.data('busy', 1).addClass('disabled').html('<i class="fa-solid fa-spinner fa-spin dropdown-item-icon"></i> Sending...');

      $.post(AJAX_URL, {
        action: 'admin_poke_client',
        ref_type: $btn.data('ref-type') || 'order',
        id: $btn.data('id') || order_id
      }, function (res) {
        let response = res;
        try { if (typeof res === 'string') response = JSON.parse(res); } catch (e) {}
        if (response && response.sendToast && typeof create_toast === 'function') {
          create_toast(response.sendToast.type || 'primary', response.sendToast.title || 'Notice', response.sendToast.message || 'Done');
        }
        if (response && response.playSound) {
          try { new Audio(asset_url + '/core/dash/audio/' + response.playSound + '.mp3').play(); } catch (e) {}
        }
      }).always(function () {
        $btn.data('busy', 0).removeClass('disabled').html(oldHtml);
      });
    });
...
(function () {
  ...
  function renderFields(context) {
    ...
    if (isRank) {
      const tierOptions = Object.keys(tiers).map(k => ({ value: k, label: tiers[k] }));
      const divisionOptions = Object.keys(divisions).map(k => ({ value: k, label: divisions[k] }));
      ...
      wrap.innerHTML = `
        <div class="row g-2">
          ...
          <div class="col-6" id="rb_division_wrap">
            ...
            <select class="form-select" id="rb_reached_division">${optHtml(divisionOptions, o.start_division)}</select>
          </div>
          ...
          <div class="col-6" id="rb_lp_full_wrap" style="display:none;">
            ...
            <input type="number" class="form-control" id="rb_reached_lp_full" min="0" max="2000" value="0">
          </div>
          <div class="col-6">
          ...
          <div class="col-6">
            ...
            <input type="text" class="form-control" value="${tiers[o.end_tier] || o.end_tier} ${divisions[o.end_division] || ''}" readonly style="background:#1f2430;color:#fff;border-color:rgba(255,255,255,0.08);">
          </div>
        </div>
      `;

      // Hide division/LP for Master+ and Unranked, matching the website behavior.
      const reachedTier = parseInt(o.start_tier ?? 0, 10);
      if (reachedTier > 7 || reachedTier === 0) {
      ...
      if (tierSel) {
        tierSel.addEventListener('change', () => {
          const t = parseInt(tierSel.value, 10);
          const divWrap = document.getElementById('rb_division_wrap');
          const lpWrap = document.getElementById('rb_lp_wrap');
          const lpFullWrap = document.getElementById('rb_lp_full_wrap');
          if (t > 7 || t === 0) {
            ...
            if (lpWrap) lpWrap.style.display = '';
  ...
  function buildProgressPayload(context) {
    ...
    if (formType === 'rank') {
      ...
      const isApex = (t > 7 || t === 0);

      const payload = { start_tier: t, lp_gain: lg };
      if (!isApex) {
  ...
  function buildAutoNote(context, progressPayload) {
    ...
    const rankLabel = (p) => {
      ...
      const base = `${tierName(t)} ${divRoman(d)}`.trim();
      return lpBand ? `${base} (${lpBand} LP)` : base;
    };
