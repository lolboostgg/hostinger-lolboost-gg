<!-- Modal - Edit Discount -->
<div class="modal fade dc-modal" id="edit_discount_md" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="edit_discount_form" class="form ajax-form" action="<?= AJAX_URL ?>">
                <input type="text" name="action" value="admin_edit_discount" hidden>
                <input type="text" name="id" value="" hidden>
                <div class="dc-modal-head">
                    <div class="dc-modal-title">
                        <div class="dc-modal-title-icon"><i class="fa-solid fa-pen-to-square"></i></div>
                        <div>
                            <h2>Edit Discount</h2>
                            <p>Update code, services, amount and usage limits.</p>
                        </div>
                    </div>
                    ...
                    <div class="dc-form-grid">
                        ...
                        <div class="dc-form-full">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="Select start and expiry date" class="js-daterangepicker form-control daterangepicker-custom-input" name="date_range" data-hs-daterangepicker-options='{"parentEl":"#edit_discount_md"}'>
                            </div>
                        </div>
                        ...
                        <div class="dc-form-full">
                            ...
                            <div class="dc-segment" role="group" aria-label="Discount amount type">
                                <input type="radio" name="is_fixed" value="0" id="is_fixed3" autocomplete="off" checked>
                                <label for="is_fixed3"><i class="fa-solid fa-percent"></i> Percentage</label>
                                <input type="radio" name="is_fixed" value="1" id="is_fixed4" autocomplete="off">
                                <label for="is_fixed4"><i class="fa-solid fa-euro-sign"></i> Fixed Amount</label>
                            </div>
                ...
                <div class="dc-modal-footer">
                    ...
                    <button type="submit" class="dc-btn dc-btn-primary" id="edit_discount_submit">
                        <span class="indicator-label"><i class="fa-solid fa-save"></i> Save Changes</span>
