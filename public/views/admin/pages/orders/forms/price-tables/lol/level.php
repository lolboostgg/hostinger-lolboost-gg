                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <input type="number" class="form-control ms-auto text-end" style="width:100px"
                                            name="eu-<?= $tier . '-' . $div ?>"
                                            value="<?= util_format_price_input($val['eu']) ?>" placeholder="5.5" step="0.01">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control ms-auto text-end" style="width:100px"
                                            name="na-<?= $tier . '-' . $div ?>"
                                            value="<?= util_format_price_input($val['na']) ?>" placeholder="5.5" step="0.01">
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
...
<div class="card mb-5">
    <div class="card-header">
        <h5 class="card-header-title">Levels Above 30</h5>
    </div>
    <div class="card-body">
        <div class="js-sticky-header">
            <!-- Table -->
                ...
                <table class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control ms-auto text-end" style="width:100px"
                                    name="per_level_eu" value="<?= util_format_price_input($data['per_level']['eu']) ?>"
                                    placeholder="5.5" step="0.01">
                            </td>
                            <td>
                                <input type="number" class="form-control ms-auto text-end" style="width:100px"
                                    name="per_level_na" value="<?= util_format_price_input($data['per_level']['na']) ?>"
                                    placeholder="5.5" step="0.01">
                            </td>
                        </tr>
                    </tbody>
