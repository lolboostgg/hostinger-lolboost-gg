...
if (!empty($_POST)) {
    ...
    if ($action === 'request_payout') {
        ...
        if ($available_cents <= 0) $lb_errors[] = 'Your available balance is not enough.';
        if ($amount_cents > $available_cents) $lb_errors[] = 'Amount exceeds your available balance.';
      ...
      <div class="card-header">
        <div class="row justify-content-between align-items-center flex-grow-1">
          <div class="col-12 col-md">
            ...
            <small class="text-muted d-block mt-1">Available balance & payout request</small>
          </div>
        </div>
      </div>
