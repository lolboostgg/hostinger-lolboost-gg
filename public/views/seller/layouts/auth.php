...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .lb-auth-hero{position:relative;min-height:100vh;display:flex;align-items:center;padding:clamp(48px,7vw,120px);overflow:hidden;background-image:linear-gradient(90deg,rgba(3,5,15,.72),rgba(5,7,20,.88)),url('<?= ASSET_URL ?>/core/main/img/banners/zed.png');background-repeat:no-repeat;background-size:cover;background-position:center}
        ...
        @media(max-width:980px){.lb-auth-shell{grid-template-columns:1fr}.lb-auth-hero{min-height:auto;padding:48px 24px}.lb-auth-panel{min-height:auto;padding:34px 18px 48px}.lb-feature-grid{grid-template-columns:1fr}.lb-auth-card{max-width:520px;padding:30px}.lb-hero-title{font-size:46px}.lb-hero-copy{font-size:16px}.lb-brand-row{margin-bottom:28px}.lb-area-badge{margin-left:0;margin-top:12px}.lb-brand-row{flex-wrap:wrap}}
    </style>
</head>
<body>
        ...
        <section class="lb-auth-hero">
            <div class="lb-auth-hero-inner">
                <div class="lb-brand-row">
                    ...
                    <span class="lb-area-badge"><i class="fa-solid fa-shield-halved"></i> Seller Area</span>
                </div>
                <div class="lb-hero-kicker"><i class="fa-solid fa-bolt"></i> Marketplace</div>
                <h1 class="lb-hero-title">Seller <span>Marketplace</span></h1>
                <p class="lb-hero-copy">Manage account listings, payouts and seller operations inside your dedicated LoLBoost seller area.</p>
                <div class="lb-feature-grid">
                    <div class="lb-feature-card"><strong>Secure</strong><span>Seller login</span></div>
                    <div class="lb-feature-card"><strong>Listings</strong><span>Account sales</span></div>
                    <div class="lb-feature-card"><strong>Payouts</strong><span>Seller tools</span></div>
                </div>
            </div>
        </section>
