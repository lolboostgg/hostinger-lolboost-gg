...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-12 col-sm-12 col-md-8 col-lg-6">
            <div class="card p-0 p-lg-4 bg-secondary">
                <div class="card-body">
                    <h3 class="card-title mb-4 text-center">Booster Application</h3>
                    <form class="ajax-form" action="<?= AJAX_URL ?>" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="address"
                                placeholder="1234 Main St, City, State, Zip" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="id_card_front" accept="image/*" required />
                        </div>
                        <div class="mb-3">
                            <label class="form-label">ID Card (Back)</label>
                            <input type="file" class="form-control" name="id_card_back" accept="image/*" required />
                        </div>
                    ...
                    <p class="text-center text-muted mb-0">
                        Already a booster?
                        <a href="/booster-area" class="text-decoration-none">Login</a>
                    </p>
                </div>
            </div>
        </div>
