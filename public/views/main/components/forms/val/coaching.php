        ...
        <div class="card-body p-4">
            ...
            <div class="row g-2">
                <div class="col form-floating">
                    <select class="form-select" style="min-width:180px" name="coach_type">
                        <option value="normal" selected="">Normal Coach</option>
                        <option value="elite">Elite Coach</option>
                    </select>
                    <label for="fl-select">Coach Type</label>
                </div>
                <div class="col form-floating">
