        ...
        <div class="card-header p-4 w-100">
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center p-3 border rounded bg-light">
                    <img src="<?= ASSET_URL ?>/core/main/img/val/ranks/mini/3.png"
        ...
        <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-start align-items-center">
                    ...
                    <?php for ($i = 1; $i <= 8; $i++): ?>
                        ...
                        <label class="btn btn-light <?= strtolower($ranks[$i]) ?>-bg" for="start_<?= $i ?>"
                            ...
                            <img src="<?= util_rank_img('val', 'mini', $i) ?>" class="rank-icon-mini"
                                alt="<?= $ranks[$i] ?>">
                        </label>
                    <?php endfor ?>
                </div>
                <!-- div -->
                <div class="col text-start" id="start_rr_full" style="display:none">
                    <label for="start_rr_full" class="fw-bold">Current RR:</label>
                    <div class="input-group">
                        <button type="button" class="btn btn-outline-dark"
                            onclick="decrementValue(startRRInput)">-</button>
                        <input type="number" id="start_rr_input" value="0" name="start_rr_full"
                            class="form-control text-center rounded-0 no-arr" placeholder="Current RR"
                            style="max-height:52px;" min="0">
                        <button type="button" class="btn btn-outline-dark"
                            onclick="incrementValue(startRRInput)">+</button>
                    </div>
                </div>
                <div class="d-flex flex-wrap gap-2 mt-2 justify-content-start align-items-center" id="start_divisions">
                    <?php for ($i = 1; $i <= 3; $i++): ?>

                        <input class="custom-checkbox" type="radio" name="start_division" value="<?= $i ?>"
                            id="start_division_<?= $i ?>" <?= $i == 1 ? "checked" : null ?>>
                        <label class="btn btn-light" for="start_division_<?= $i ?>">
                            <span class="rank-icon-mini"><?= util_format_val_division($i) ?></span>
                        </label>
            ...
            <div class="row g-2">
                <div class="col form-floating">
                    <select class="form-select" style="min-width:180px" name="start_rr">
            ...
            <div class="">
                <div class="d-flex flex-wrap gap-2 justify-content-start align-items-center">
                    ...
                    <?php for ($i = 1; $i <= 8; $i++): ?>
                        ...
                        <!-- <?= $ranks[$i] ?> -->
                        <input class="custom-checkbox" type="radio" name="end_tier" id="end_<?= $i ?>" value="<?= $i ?>"
                            <?= $i == 3 ? "checked" : null ?>>
                        <label class="btn btn-light <?= strtolower($ranks[$i]) ?>-bg" for="end_<?= $i ?>"
                            data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $ranks[$i] ?>"
                            data-bs-custom-class="<?= strtolower($ranks[$i]) ?>">
                            <img src="<?= util_rank_img('val', 'mini', $i) ?>" class="rank-icon-mini"
                                alt="<?= $ranks[$i] ?>">
                ...
                <div class="col text-start" id="end_rr_full" style="display:none">
                    <label class="fw-bold" for="end_rr_full">Desired RR:</label>
                    <div class="input-group">
                        <button type="button" class="btn btn-outline-dark"
                            onclick="decrementValue(endRRInput)">-</button>
                        <input type="number" id="end_rr_input" value="0" name="end_rr_full"
                            class="form-control text-center rounded-0 no-arr" placeholder="Desired RR"
                            style="max-height:52px;" min="0">
                        <button type="button" class="btn btn-outline-dark"
                            onclick="incrementValue(endRRInput)">+</button>
                    </div>
                </div>
                <div class="d-flex flex-wrap gap-2 mt-2 justify-content-start align-items-center" id="end_divisions">
                    ...
                    <?php for ($i = 1; $i <= 3; $i++): ?>
                        ...
                        <input class="custom-checkbox" type="radio" name="end_division" id="end_division_<?= $i ?>"
                            value="<?= $i ?>" <?= $i == 3 ? "checked" : null ?>>
                        <label class="btn btn-light" for="end_division_<?= $i ?>">
                            <span class="rank-icon-mini"><?= util_format_val_division($i) ?></span>
                        </label>
                ...
                <div class="d-flex align-items-center justify-content-center gap-3">
                    <p class="mb-0">
                        ...
                        <span class="fw-bold">
                            ...
                            <small class="text-muted ms-1 ms-md-2 fw-normal current-summary-lp">[ 0-20 RR ]</small>
                        </span>
                    </p>
                    ...
                    <p class="mb-0">
                        ...
                        <span class="fw-bold">
                            <span class="desired-summary-rank-name">Silver III</span>
            ...
            <div class="options-list mt-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <p class="mb-0 text-dark">
                        <i class="fa-regular fa-circle-info text-muted me-2" data-bs-toggle="popover"
                            data-bs-placement="top" data-bs-trigger="hover"
                            data-bs-content="Your booster will win an additional game after you reach your desired rank."></i>
                        +1 Bonus Win
                        <span class="badge rounded fw-bold bg-faded-primary ms-2 text-primary">AUTO</span>
                    </p>
                    <label class="switch">
