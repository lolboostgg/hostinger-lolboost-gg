        ...
        <div class="card-header p-4 w-100">
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center p-3 border rounded bg-light">
                    <img src="<?= ASSET_URL ?>/core/main/img/lol/arenas/3.webp" class="rank-icon-mini current-rank-img"
                        alt="wood">
                </div>
                <h4 class="mb-0 ms-3">
                    <?= t('Current Rank') ?>
                    <p class="mb-0 text-muted me-2">
                        <?= t('Select your current arena rank.') ?>
                    </p>
                </h4>
            </div>
        </div>
            ...
            <div class="mb-5">
                <div class="d-flex flex-wrap gap-2 justify-content-start align-items-center">
                    ...
                    <?php for ($i = 1; $i <= 5; $i++): ?>
                        ...
                        <label class="btn btn-light <?= strtolower($arenas[$i]) ?>-bg" for="start_<?= $i ?>"
                            data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $arenas[$i] ?>"
                            data-bs-custom-class="<?= strtolower($arenas[$i]) ?>">
                            <img src="<?= ASSET_URL ?>/core/main/img/lol/arenas/<?= $i ?>.webp" class="rank-icon-mini"
                                alt="<?= $arenas[$i] ?>">
                        </label>
                    <?php endfor ?>
                </div>
            ...
            <div class="rank-sec bg-light p-3 mb-3 mx-n4 mt-n4 border-bottom">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    <p class="mb-0 d-flex align-items-center gap-2">
                        <img src="<?= ASSET_URL ?>/core/main/img/lol/arenas/3.webp"
                            class="rank-icon-mini current-summary-rank-img" alt="Platinum" style="width: 40px;">
                        <span class="fw-bold">
                            <span class="current-summary-rank-name">Silver</span>
                    ...
                    <p class="mb-0">
                        <span class="fw-bold overview-count">
                            <span class="win-count">2</span> <?= t('Wins') ?>
                        </span>
                    </p>
                </div>
            </div>
