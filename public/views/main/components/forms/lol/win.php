        ...
        <div class="card-header p-4 w-100">
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center p-3 border rounded bg-light">
                    <img src="<?= ASSET_URL ?>/core/main/img/lol/ranks/mini/3.png" class="rank-icon-mini current-rank-img"
                        alt="Platinum">
                </div>
                <h4 class="mb-0 ms-3">
                    <?= t('Current Rank') ?>
        ...
        <div class="card-body p-4">
            <div class="mb-5">
                <div class="d-flex flex-wrap gap-2 justify-content-start align-items-center">
                    ...
                    <!-- <?= $ranks[$i] ?> -->
                    <input class="custom-checkbox" type="radio" name="start_tier" id="start_<?= $i ?>"
                ...
                <div class="col text-start mt-md-1 mt-3" id="start_lp_full" style="display:none">
            ...
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center py-3 px-4 border rounded bg-light">
                    <h3 class="mb-0 text-gradient-primary">
                        <span class="win-count">2</span>
                    </h3>
                </div>
                <h4 class="mb-0 ms-3">
                    <?= t('Wins Amount') ?>
                    <p class="mb-0 text-muted me-2">
                        <?= t('Select your desired amount of wins.') ?>
                    </p>
                </h4>
            </div>
        </div>
                ...
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <p class="mb-0">
                        <span class="fw-bold overview-count">
                            <span class="win-count">2</span> Wins
                        </span>
                    </p>
                </div>
            </div>
            ...
            <div class="options-list mt-4">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0 text-dark">
                        ...
                        <?= t('Champs & Roles') ?>
                        <span class="badge rounded fw-bold bg-faded-success ms-2 text-success">FREE</span>
                    </p>
                    <label class="switch">
