        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:980px){
            ...
            .lb-auth-panel {
                ...
                padding: 24px 16px 40px; min-height: unset; width: 100%;
                box-sizing: border-box; background: transparent;
            }
            .lb-auth-card {
                width: 100%; max-width: min(480px, 100%);
                padding: clamp(22px, 6vw, 36px); border-radius: 22px; box-sizing: border-box;
            }
            .lb-auth-title, .lb-auth-card .display-5 { font-size: clamp(32px, 9vw, 46px); }
            .lb-auth-subtitle, .lb-auth-card p { font-size: 14px; }
            .lb-auth-card label { font-size: 13px; }
            .lb-auth-card label.lb-check { display: flex; margin: 4px 0 24px; }
            .lb-auth-card input[type=email], .lb-auth-card input[type=password],
            .lb-auth-card input[type=text], .lb-input { height: 56px; font-size: 15px; }
        ...
        <section class="lb-auth-hero">
            <div class="lb-auth-hero-inner">
                <div class="lb-brand-row">
                    ...
                    <span class="lb-area-badge"><i class="fa-solid fa-shield-halved"></i> Booster Area</span>
                </div>
                <div class="lb-hero-kicker"><i class="fa-solid fa-bolt"></i> Boosting Hub</div>
                <h1 class="lb-hero-title">Booster <span>Hub</span></h1>
                <p class="lb-hero-copy">Access your assigned orders, track progress and manage booster work from one focused dashboard.</p>
                <div class="lb-feature-grid">
                    <div class="lb-feature-card"><strong>Secure</strong><span>Protected access</span></div>
                    <div class="lb-feature-card"><strong>Orders</strong><span>Work overview</span></div>
                    <div class="lb-feature-card"><strong>Live</strong><span>Order updates</span></div>
                </div>
            </div>
        </section>
