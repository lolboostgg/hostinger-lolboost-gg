...
<?php
    ...
    {
        // util_get_lol_rank() returns null for an empty/invalid rank (e.g. an
        // account row with no rank set). Coerce to string so this typed function
        // never throws a TypeError and crashes the whole account page.
...
(function () {
    ...
    var navigationEntry = performance.getEntriesByType
        ...
        : null;
    var isHistoryNavigation = navigationEntry && navigationEntry.type === 'back_forward';
    ...
    function resetAccountPageScroll() {
    ...
    resetAccountPageScroll();
    document.addEventListener('DOMContentLoaded', resetAccountPageScroll, { once: true });
    window.addEventListener('load', function () {
        resetAccountPageScroll();
        window.requestAnimationFrame(resetAccountPageScroll);
        setTimeout(resetAccountPageScroll, 120);
    }, { once: true });
})();
</script>
